...
export const ourStory: about[] = [
  {
    ...
    title: "Our Story",
    content: {
      paragraph_1: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris
      ...
      paragraph_2: `Donec gravida lorem elit, quis condimentum ex semper sit amet.
                ...
                ligula.`,
      paragraph_3: `Any questions? Let us know in store at 8th floor, 379 Hudson St,
                New York, NY 10018 or call us on (+1) 96 716 6879`,
    },
  },
];

export const ourMission: about[] = [
  {
    title: "Our Mission",
    content: {
      paragraph_1: `Mauris non lacinia magna. Sed nec lobortis dolor. Vestibulum
      ...
      paragraph_2: `Creativity is just connecting things. When you ask creative
                  people how they did something, they feel a little guilty
                  because they didn't really do it, they just saw something. It
                  seemed obvious to them after a while. - Steve Job’s`,
    },
  },
];
